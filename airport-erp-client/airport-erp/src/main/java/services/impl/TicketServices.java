...
public class TicketServices implements TicketServicesRemote, TicketServicesLocal {
	...
	public Boolean deleteTicket(Ticket ticket) {
		...
		try {
			ticket = findTicketByFlightIdAndPassengerId(passenger.getId(), flight.getId());
	...
	public List<Ticket> findAllTicketsByPassengerId(Integer passengerId) {
		Passenger passenger = passengerServicesLocal.findPassengerById(passengerId);
	...
	@Override
	public Boolean bookTicketBis(Integer idPassenger, Integer idFlight, FlightCategory flightCategory) {
		...
		Flight flight = flightServicesLocal.findFlightById(idFlight);
			...
			flight.getFreePlacesMap().put(flightCategory, flight.getFreePlacesMap().get(flightCategory) - 1);
			b = true;
	...
	@Override
	public Ticket findTicketByFlightIdAndPassengerId(Integer idPassenger, Integer idFlight) {
		Passenger passenger = passengerServicesLocal.findPassengerById(idPassenger);
		Flight flight = flightServicesLocal.findFlightById(idFlight);
